...
public class GenRecipeProvider extends RecipeProvider {
    ...
    public GenRecipeProvider(PackOutput packOutput, CompletableFuture<HolderLookup.Provider> provider) {
    ...
    protected void buildRecipes(RecipeOutput consumer) {
        ...
        Utils.generateSmelting(consumer, "dyes", Items.COCOA_BEANS, Items.BROWN_DYE, RecipeSerializer.SMOKING_RECIPE, 0.01f);
        Utils.generateSmelting(consumer, "dyes", Items.BONE_MEAL, Items.WHITE_DYE, RecipeSerializer.SMOKING_RECIPE, 0.01f);
        Utils.generateSmelting(consumer, "dyes", Items.INK_SAC, Items.BLACK_DYE, RecipeSerializer.SMOKING_RECIPE, 0.01f);
        ...
        Utils.generateSmelting(consumer, "dyes", Items.PINK_PETALS, Items.PINK_DYE, RecipeSerializer.SMOKING_RECIPE, 0.01f);
        ...
        Utils.generateSmelting(consumer, "dyes", Items.BEETROOT, Items.RED_DYE, RecipeSerializer.SMOKING_RECIPE, 0.01f);
        ...
        Utils.generateSmelting(consumer, "dyes", Items.PITCHER_PLANT, Items.CYAN_DYE, RecipeSerializer.SMOKING_RECIPE, 0.01f);

        // =============================================================================================================
        // Dye [SMELTING] Recipes
        // =============================================================================================================

        Utils.generateSmelting(consumer, "dyes", Items.COCOA_BEANS, Items.BROWN_DYE, RecipeSerializer.SMELTING_RECIPE, 0.01f);
        Utils.generateSmelting(consumer, "dyes", Items.BONE_MEAL, Items.WHITE_DYE, RecipeSerializer.SMELTING_RECIPE, 0.01f);
        Utils.generateSmelting(consumer, "dyes", Items.INK_SAC, Items.BLACK_DYE, RecipeSerializer.SMELTING_RECIPE, 0.01f);
        ...
        Utils.generateSmelting(consumer, "dyes", Items.PINK_PETALS, Items.PINK_DYE, RecipeSerializer.SMELTING_RECIPE, 0.01f);
        ...
        Utils.generateSmelting(consumer, "dyes", Items.BEETROOT, Items.RED_DYE, RecipeSerializer.SMELTING_RECIPE, 0.01f);
        ...
        Utils.generateSmelting(consumer, "dyes", Items.PITCHER_PLANT, Items.CYAN_DYE, RecipeSerializer.SMELTING_RECIPE, 0.01f);
        ...
        // =============================================================================================================
        // Better Slab Recipe (Slab + Slime Ball -> Block)
        // =============================================================================================================
        ...
        // =============================================================================================================
        // Better Carpet Recipe (Carpet + Slime Ball -> Block)
        // =============================================================================================================
        ...
        // =============================================================================================================
        // Better Wool Recipe (Block -> Carpet)
        // =============================================================================================================
